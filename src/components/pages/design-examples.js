  ...
  render() {
    ...
    return (
      <Rt.HomeLayout >
        ...
        <img className="miCapLogo" src="../imgs/micapital-stack.png" alt="MI Capital" />
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://micapitaladvisors.com/"> visit MI Capital </a>
